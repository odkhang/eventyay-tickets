...
urlpatterns = [
    url(
        r"^oauth2/authorize/",
        CustomAuthorizationView.as_view(),
    ...
    url(
        r"^global/settings/$",
        global_settings.GlobalSettingsView.as_view(),
        name="global.settings",
    ),
    url(
        r"^global/update/$",
        global_settings.UpdateCheckView.as_view(),
        name="global.update",
    ),
    url(
        r"^global/message/$",
        global_settings.MessageView.as_view(),
        name="global.message",
    ),
    url(
        r"^logdetail/$",
    ...
    url(
        r"^users/(?P<id>\d+)/reset$", users.UserResetView.as_view(), name="users.reset"
    ),
    url(
    ...
    url(
        r"^users/(?P<id>\d+)/anonymize",
        users.UserAnonymizeView.as_view(),
    ...
    url(
        r"^settings/history/$",
        user.UserHistoryView.as_view(),
        name="user.settings.history",
    ),
    url(
        r"^settings/notifications/$",
        user.UserNotificationsEditView.as_view(),
        name="user.settings.notifications",
    ),
    url(
        r"^settings/notifications/off/(?P<id>\d+)/(?P<token>[^/]+)/$",
        user.UserNotificationsDisableView.as_view(),
        name="user.settings.notifications.off",
    ),
    url(
        r"^settings/oauth/authorized/$",
        oauth.AuthorizationListView.as_view(),
        name="user.settings.oauth.list",
    ),
    url(
        r"^settings/oauth/authorized/(?P<pk>\d+)/revoke$",
        oauth.AuthorizationRevokeView.as_view(),
        name="user.settings.oauth.revoke",
    ),
    url(
        r"^settings/oauth/apps/$",
        oauth.OAuthApplicationListView.as_view(),
        name="user.settings.oauth.apps",
    ),
    url(
        r"^settings/oauth/apps/add$",
        oauth.OAuthApplicationRegistrationView.as_view(),
        name="user.settings.oauth.apps.register",
    ),
    url(
        r"^settings/oauth/apps/(?P<pk>\d+)/$",
        oauth.OAuthApplicationUpdateView.as_view(),
        name="user.settings.oauth.app",
    ),
    url(
        r"^settings/oauth/apps/(?P<pk>\d+)/disable$",
        oauth.OAuthApplicationDeleteView.as_view(),
        name="user.settings.oauth.app.disable",
    ),
    url(
        r"^settings/oauth/apps/(?P<pk>\d+)/roll$",
        oauth.OAuthApplicationRollView.as_view(),
        name="user.settings.oauth.app.roll",
    ),
    url(r"^settings/2fa/$", user.User2FAMainView.as_view(), name="user.settings.2fa"),
    url(
        r"^settings/2fa/add$",
        user.User2FADeviceAddView.as_view(),
        name="user.settings.2fa.add",
    ),
    url(
        r"^settings/2fa/enable",
        user.User2FAEnableView.as_view(),
        name="user.settings.2fa.enable",
    ),
    url(
        r"^settings/2fa/disable",
        user.User2FADisableView.as_view(),
        name="user.settings.2fa.disable",
    ),
    url(
        r"^settings/2fa/regenemergency",
        user.User2FARegenerateEmergencyView.as_view(),
        name="user.settings.2fa.regenemergency",
    ),
    url(
        r"^settings/2fa/totp/(?P<device>[0-9]+)/confirm",
        user.User2FADeviceConfirmTOTPView.as_view(),
        name="user.settings.2fa.confirm.totp",
    ),
    url(
        r"^settings/2fa/webauthn/(?P<device>[0-9]+)/confirm",
        user.User2FADeviceConfirmWebAuthnView.as_view(),
        name="user.settings.2fa.confirm.webauthn",
    ),
    url(
        r"^settings/2fa/(?P<devicetype>[^/]+)/(?P<device>[0-9]+)/delete",
        user.User2FADeviceDeleteView.as_view(),
        name="user.settings.2fa.delete",
    ),
    url(
        r"^organizers/$",
        organizer_views.organizer_view.OrganizerList.as_view(),
        name="organizers",
    ),
    url(
        r"^organizers/add$",
    ...
    url(
        r"^organizer/(?P<organizer>[^/]+)/settings/email$",
        organizer_views.organizer_view.OrganizerMailSettings.as_view(),
        name="organizer.settings.mail",
    ),
    url(
    ...
    url(
        r"^organizer/(?P<organizer>[^/]+)/settings/email/preview$",
        organizer_views.MailSettingsPreview.as_view(),
        name="organizer.settings.mail.preview",
    ),
    url(
    ...
    url(
        r"^organizer/(?P<organizer>[^/]+)/customers$",
        organizer_views.customer_view.CustomerListView.as_view(),
        name="organizer.customers",
    ),
    url(
        r"^organizer/(?P<organizer>[^/]+)/customers/select2$",
        typeahead.customer_select2,
        name="organizer.customers.select2",
    ),
    url(
        r"^organizer/(?P<organizer>[^/]+)/customer/(?P<customer>[^/]+)/$",
        organizer_views.customer_view.CustomerDetailView.as_view(),
        name="organizer.customer",
    ),
    url(
        r"^organizer/(?P<organizer>[^/]+)/customer/(?P<customer>[^/]+)/edit$",
        organizer_views.customer_view.CustomerUpdateView.as_view(),
        name="organizer.customer.edit",
    ),
    url(
        r"^organizer/(?P<organizer>[^/]+)/customer/(?P<customer>[^/]+)/anonymize$",
        organizer_views.customer_view.CustomerAnonymizeView.as_view(),
        name="organizer.customer.anonymize",
    ),
    url(
        r"^organizer/(?P<organizer>[^/]+)/ssoproviders$",
        organizer_views.sso_provider_view.SSOProviderListView.as_view(),
        name="organizer.ssoproviders",
    ),
    url(
        r"^organizer/(?P<organizer>[^/]+)/ssoprovider/add$",
        organizer_views.sso_provider_view.SSOProviderCreateView.as_view(),
        name="organizer.ssoprovider.add",
    ),
    url(
        r"^organizer/(?P<organizer>[^/]+)/ssoprovider/(?P<provider>[^/]+)/edit$",
        organizer_views.sso_provider_view.SSOProviderUpdateView.as_view(),
        name="organizer.ssoprovider.edit",
    ),
    url(
        r"^organizer/(?P<organizer>[^/]+)/ssoprovider/(?P<provider>[^/]+)/delete$",
        organizer_views.sso_provider_view.SSOProviderDeleteView.as_view(),
        name="organizer.ssoprovider.delete",
    ),
    url(
        r"^organizer/(?P<organizer>[^/]+)/ssoclients$",
        organizer_views.sso_provider_view.SSOClientListView.as_view(),
        name="organizer.ssoclients",
    ),
    url(
        r"^organizer/(?P<organizer>[^/]+)/ssoclient/add$",
        organizer_views.sso_provider_view.SSOClientCreateView.as_view(),
        name="organizer.ssoclient.add",
    ),
    url(
        r"^organizer/(?P<organizer>[^/]+)/ssoclient/(?P<client>[^/]+)/edit$",
        organizer_views.sso_provider_view.SSOClientUpdateView.as_view(),
        name="organizer.ssoclient.edit",
    ),
    url(
        r"^organizer/(?P<organizer>[^/]+)/ssoclient/(?P<client>[^/]+)/delete$",
    ...
    url(
        ...
        include(
            [
                ...
                url(
                    r"^qrcode.(?P<filetype>(png|jpeg|gif|svg))$",
                    event.EventQRCode.as_view(),
                    name="event.qrcode",
                ),
                ...
                url(
                    r"^requiredactions/$",
                    event.EventActions.as_view(),
                    name="event.requiredactions",
                ),
                url(
                ...
                url(
                    r"^settings/payment$",
                    event.PaymentSettings.as_view(),
                    name="event.settings.payment",
                ),
                url(
                    r"^settings/tickets$",
                    event.TicketSettings.as_view(),
                    name="event.settings.tickets",
                ),
                url(
                ...
                url(
                    r"^settings/email$",
                    event.MailSettings.as_view(),
                    name="event.settings.mail",
                ),
                url(
                    r"^settings/email/preview$",
                    event.MailSettingsPreview.as_view(),
                    name="event.settings.mail.preview",
                ),
                url(
                ...
                url(
                    r"^settings/cancel",
                    event.CancelSettings.as_view(),
                    name="event.settings.cancel",
                ),
                url(
                    r"^settings/invoice$",
                    event.InvoiceSettings.as_view(),
                    name="event.settings.invoice",
                ),
                url(
                    r"^settings/invoice/preview$",
                    event.InvoicePreview.as_view(),
                    name="event.settings.invoice.preview",
                ),
                url(
                    r"^settings/display",
                    event.DisplaySettings.as_view(),
                    name="event.settings.display",
                ),
                url(
                    r"^settings/tax/$",
                    event.TaxList.as_view(),
                    name="event.settings.tax",
                ),
                url(
                    r"^settings/tax/(?P<rule>\d+)/$",
                    event.TaxUpdate.as_view(),
                    name="event.settings.tax.edit",
                ),
                url(
                    r"^settings/tax/add$",
                    event.TaxCreate.as_view(),
                    name="event.settings.tax.add",
                ),
                url(
                    r"^settings/tax/(?P<rule>\d+)/delete$",
                    event.TaxDelete.as_view(),
                    name="event.settings.tax.delete",
                ),
                url(
                    r"^settings/widget$",
                    event.WidgetSettings.as_view(),
                    name="event.settings.widget",
                ),
                url(
                    r"^pdf/editor/webfonts.css",
                    pdf.FontsCSSView.as_view(),
                    name="pdf.css",
                ),
                url(
                    r"^pdf/editor/(?P<filename>[^/]+).pdf$",
                    pdf.PdfView.as_view(),
                    name="pdf.background",
                ),
                url(
                    r"^subevents/$",
                    subevents.SubEventList.as_view(),
                    name="event.subevents",
                ),
                url(
                    r"^subevents/select2$",
                    typeahead.subevent_select2,
                    name="event.subevents.select2",
                ),
                url(
                    r"^subevents/(?P<subevent>\d+)/$",
                    subevents.SubEventUpdate.as_view(),
                    name="event.subevent",
                ),
                url(
                ...
                url(
                    r"^subevents/add$",
                    subevents.SubEventCreate.as_view(),
                    name="event.subevents.add",
                ),
                url(
                    r"^subevents/bulk_add$",
                    subevents.SubEventBulkCreate.as_view(),
                    name="event.subevents.bulk",
                ),
                url(
                ...
                url(
                    r"^subevents/bulk_edit$",
                    subevents.SubEventBulkEdit.as_view(),
                    name="event.subevents.bulkedit",
                ),
                url(r"^items/$", item.ItemList.as_view(), name="event.items"),
                url(r"^items/add$", item.ItemCreate.as_view(), name="event.items.add"),
                url(
                    r"^items/(?P<item>\d+)/$",
                    item.ItemUpdateGeneral.as_view(),
                    name="event.item",
                ),
                url(
                    r"^items/(?P<item>\d+)/up$",
                ...
                url(
                    r"^items/(?P<item>\d+)/down$",
                    item.item_move_down,
                    name="event.items.down",
                ),
                url(
                    r"^items/(?P<item>\d+)/delete$",
                    item.ItemDelete.as_view(),
                    name="event.items.delete",
                ),
                url(
                    r"^items/typeahead/meta/$",
                    typeahead.item_meta_values,
                    name="event.items.meta.typeahead",
                ),
                url(
                    r"^items/select2$",
                    typeahead.items_select2,
                    name="event.items.select2",
                ),
                url(
                    r"^items/select2/variation$",
                    typeahead.variations_select2,
                    name="event.items.variations.select2",
                ),
                url(
                    r"^categories/$",
                    item.CategoryList.as_view(),
                    name="event.items.categories",
                ),
                url(
                    r"^categories/select2$",
                    typeahead.category_select2,
                    name="event.items.categories.select2",
                ),
                url(
                    r"^categories/(?P<category>\d+)/delete$",
                    item.CategoryDelete.as_view(),
                    name="event.items.categories.delete",
                ),
                url(
                    r"^categories/(?P<category>\d+)/up$",
                    item.category_move_up,
                    name="event.items.categories.up",
                ),
                url(
                    r"^categories/(?P<category>\d+)/down$",
                    item.category_move_down,
                    name="event.items.categories.down",
                ),
                url(
                    r"^categories/(?P<category>\d+)/$",
                    item.CategoryUpdate.as_view(),
                    name="event.items.categories.edit",
                ),
                url(
                    r"^categories/add$",
                    item.CategoryCreate.as_view(),
                    name="event.items.categories.add",
                ),
                url(
                    r"^questions/$",
                    item.QuestionList.as_view(),
                    name="event.items.questions",
                ),
                url(
                    r"^questions/reorder$",
                    item.reorder_questions,
                    name="event.items.questions.reorder",
                ),
                url(
                    r"^questions/(?P<question>\d+)/delete$",
                    item.QuestionDelete.as_view(),
                    name="event.items.questions.delete",
                ),
                url(
                    r"^questions/(?P<question>\d+)/$",
                    item.QuestionView.as_view(),
                    name="event.items.questions.show",
                ),
                url(
                    r"^questions/(?P<question>\d+)/change$",
                    item.QuestionUpdate.as_view(),
                    name="event.items.questions.edit",
                ),
                url(
                    r"^questions/add$",
                    item.QuestionCreate.as_view(),
                    name="event.items.questions.add",
                ),
                url(
                    r"^descriptions/add$",
                    item.DescriptionCreate.as_view(),
                    name="event.items.descriptions.add",
                ),
                url(
                    r"^descriptions/(?P<question>\d+)/change$",
                    item.DescriptionUpdate.as_view(),
                    name="event.items.descriptions.edit",
                ),
                url(
                    r"^descriptions/(?P<question>\d+)/delete$",
                    item.QuestionDelete.as_view(),
                    name="event.items.descriptions.delete",
                ),
                url(r"^quotas/$", item.QuotaList.as_view(), name="event.items.quotas"),
                url(
                    r"^quotas/(?P<quota>\d+)/$",
                    item.QuotaView.as_view(),
                    name="event.items.quotas.show",
                ),
                url(
                    r"^quotas/select$",
                    typeahead.quotas_select2,
                    name="event.items.quotas.select2",
                ),
                url(
                    r"^quotas/(?P<quota>\d+)/change$",
                    item.QuotaUpdate.as_view(),
                    name="event.items.quotas.edit",
                ),
                url(
                    r"^quotas/(?P<quota>\d+)/delete$",
                    item.QuotaDelete.as_view(),
                    name="event.items.quotas.delete",
                ),
                url(
                    r"^quotas/add$",
                    item.QuotaCreate.as_view(),
                    name="event.items.quotas.add",
                ),
                url(
                    r"^vouchers/$",
                    vouchers.VoucherList.as_view(),
                    name="event.vouchers",
                ),
                url(
                    r"^vouchers/tags/$",
                    vouchers.VoucherTags.as_view(),
                    name="event.vouchers.tags",
                ),
                url(
                    r"^vouchers/rng$",
                    vouchers.VoucherRNG.as_view(),
                    name="event.vouchers.rng",
                ),
                url(
                    r"^vouchers/item_select$",
                    typeahead.itemvarquota_select2,
                    name="event.vouchers.itemselect2",
                ),
                url(
                    r"^vouchers/(?P<voucher>\d+)/$",
                    vouchers.VoucherUpdate.as_view(),
                    name="event.voucher",
                ),
                url(
                    r"^vouchers/(?P<voucher>\d+)/delete$",
                    vouchers.VoucherDelete.as_view(),
                    name="event.voucher.delete",
                ),
                url(
                    r"^vouchers/add$",
                    vouchers.VoucherCreate.as_view(),
                    name="event.vouchers.add",
                ),
                url(
                    r"^vouchers/go$",
                    vouchers.VoucherGo.as_view(),
                    name="event.vouchers.go",
                ),
                url(
                    r"^vouchers/bulk_add$",
                    vouchers.VoucherBulkCreate.as_view(),
                    name="event.vouchers.bulk",
                ),
                url(
                    r"^vouchers/bulk_action$",
                    vouchers.VoucherBulkAction.as_view(),
                    name="event.vouchers.bulkaction",
                ),
                url(
                ...
                url(
                    r"^orders/(?P<code>[0-9A-Z]+)/extend$",
                    orders.OrderExtend.as_view(),
                ...
                url(
                    r"^orders/(?P<code>[0-9A-Z]+)/locale",
                    orders.OrderLocaleChange.as_view(),
                    name="event.order.locale",
                ),
                url(
                    r"^orders/(?P<code>[0-9A-Z]+)/comment$",
                    orders.OrderComment.as_view(),
                    name="event.order.comment",
                ),
                url(
                    r"^orders/(?P<code>[0-9A-Z]+)/change$",
                    orders.OrderChange.as_view(),
                    name="event.order.change",
                ),
                url(
                    r"^orders/(?P<code>[0-9A-Z]+)/approve",
                    orders.OrderApprove.as_view(),
                    name="event.order.approve",
                ),
                url(
                    r"^orders/(?P<code>[0-9A-Z]+)/deny$",
                    orders.OrderDeny.as_view(),
                    name="event.order.deny",
                ),
                url(
                    r"^orders/(?P<code>[0-9A-Z]+)/delete$",
                    orders.OrderDelete.as_view(),
                ...
                url(
                    r"^orders/(?P<code>[0-9A-Z]+)/$",
                    orders.OrderDetail.as_view(),
                    name="event.order",
                ),
                url(
                    r"^invoice/(?P<invoice>[^/]+)$",
                    orders.InvoiceDownload.as_view(),
                    name="event.invoice.download",
                ),
                url(
                    r"^orders/overview/$",
                    orders.OverView.as_view(),
                    name="event.orders.overview",
                ),
                url(
                    r"^orders/import/$",
                    orderimport.ImportView.as_view(),
                    name="event.orders.import",
                ),
                url(
                ...
                url(
                    ...
                    name="event.orders.export",
                ),
                url(
                    r"^orders/export/do$",
                    orders.ExportDoView.as_view(),
                    name="event.orders.export.do",
                ),
                url(
                    r"^orders/refunds/$",
                    orders.RefundList.as_view(),
                    name="event.orders.refunds",
                ),
                url(r"^orders/go$", orders.OrderGo.as_view(), name="event.orders.go"),
                url(r"^orders/$", orders.OrderList.as_view(), name="event.orders"),
                url(
                    r"^orders/search$",
                    orders.OrderSearch.as_view(),
                    name="event.orders.search",
                ),
                url(
                    r"^dangerzone/$",
                    event.DangerZone.as_view(),
                    name="event.dangerzone",
                ),
                url(r"^cancel/$", orders.EventCancel.as_view(), name="event.cancel"),
                url(
                    r"^shredder/$",
                    shredder.StartShredView.as_view(),
                    name="event.shredder.start",
                ),
                url(
                    r"^shredder/export$",
                    shredder.ShredExportView.as_view(),
                    name="event.shredder.export",
                ),
                url(
                ...
                url(
                    r"^shredder/shred",
                    shredder.ShredDoView.as_view(),
                    name="event.shredder.shred",
                ),
                url(
                    r"^waitinglist/$",
                    waitinglist.WaitingListView.as_view(),
                    name="event.orders.waitinglist",
                ),
                url(
                    r"^waitinglist/auto_assign$",
                    waitinglist.AutoAssign.as_view(),
                    name="event.orders.waitinglist.auto",
                ),
                url(
                ...
                url(
                    r"^checkinlists/$",
                    checkin.CheckinListList.as_view(),
                    name="event.orders.checkinlists",
                ),
                url(
                    r"^checkinlists/add$",
                    checkin.CheckinListCreate.as_view(),
                    name="event.orders.checkinlists.add",
                ),
                url(
                    r"^checkinlists/select2$",
                    typeahead.checkinlist_select2,
                    name="event.orders.checkinlists.select2",
                ),
                url(
