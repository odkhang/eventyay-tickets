...
urlpatterns = [
    ...
    url(r'^organizer/(?P<organizer>[^/]+)/$', organizer_views.organizer_view.OrganizerDetail.as_view(), name='organizer'),
    url(r'^organizer/(?P<organizer>[^/]+)/edit$', organizer_views.organizer_view.OrganizerUpdate.as_view(), name='organizer.edit'),
    ...
    url(r'^organizer/(?P<organizer>[^/]+)/webhook/add$', organizer_views.web_hook_view.WebHookCreateView.as_view(),
        name='organizer.webhook.add'),
    url(r'^organizer/(?P<organizer>[^/]+)/webhook/(?P<webhook>[^/]+)/edit$', organizer_views.web_hook_view.WebHookUpdateView.as_view(),
    ...
    url(r'^organizer/(?P<organizer>[^/]+)/device/(?P<device>[^/]+)/edit$', organizer_views.device_view.DeviceUpdateView.as_view(),
        name='organizer.device.edit'),
    url(r'^organizer/(?P<organizer>[^/]+)/device/(?P<device>[^/]+)/connect$', organizer_views.device_view.DeviceConnectView.as_view(),
        name='organizer.device.connect'),
    url(r'^organizer/(?P<organizer>[^/]+)/device/(?P<device>[^/]+)/revoke$', organizer_views.device_view.DeviceRevokeView.as_view(),
        name='organizer.device.revoke'),
    url(r'^organizer/(?P<organizer>[^/]+)/device/(?P<device>[^/]+)/logs$', organizer_views.device_view.DeviceLogView.as_view(),
        name='organizer.device.logs'),
    url(r'^organizer/(?P<organizer>[^/]+)/gates$', organizer_views.gate_view.GateListView.as_view(), name='organizer.gates'),
    url(r'^organizer/(?P<organizer>[^/]+)/gate/add$', organizer_views.gate_view.GateCreateView.as_view(), name='organizer.gate.add'),
    url(r'^organizer/(?P<organizer>[^/]+)/gate/(?P<gate>[^/]+)/edit$', organizer_views.gate_view.GateUpdateView.as_view(),
        name='organizer.gate.edit'),
    url(r'^organizer/(?P<organizer>[^/]+)/gate/(?P<gate>[^/]+)/delete$', organizer_views.gate_view.GateDeleteView.as_view(),
        name='organizer.gate.delete'),
    url(r'^organizer/(?P<organizer>[^/]+)/teams$', organizer_views.team_view.TeamListView.as_view(), name='organizer.teams'),
    url(r'^organizer/(?P<organizer>[^/]+)/team/add$', organizer_views.team_view.TeamCreateView.as_view(), name='organizer.team.add'),
    url(r'^organizer/(?P<organizer>[^/]+)/team/(?P<team>[^/]+)/$', organizer_views.team_view.TeamMemberView.as_view(),
        name='organizer.team'),
    url(r'^organizer/(?P<organizer>[^/]+)/team/(?P<team>[^/]+)/edit$', organizer_views.team_view.TeamUpdateView.as_view(),
        name='organizer.team.edit'),
    url(r'^organizer/(?P<organizer>[^/]+)/team/(?P<team>[^/]+)/delete$', organizer_views.team_view.TeamDeleteView.as_view(),
    ...
    url(r'^admin/', include([
        ...
        url(r'^invoices/$', admin.InvoiceList.as_view(), name='admin.invoices'),
        url(r'^invoice/(?P<id>[^/]+)', admin.InvoiceDetail.as_view(), name='admin.invoice.detail'),
